...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer YOUR_API_KEY' http://817baa78-83db-432d-bc5d-c8d4cf03d495.westeurope.azurecontainer.io/score
